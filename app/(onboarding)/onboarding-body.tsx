...
export default function OnboardingBodyScreen() {
    ...
    React.useEffect(() => {
        ...
        const timer = setTimeout(() => {
            const resolvedCultural = culturalFoodContext === 'Other' && otherCulturalInput.trim()
                ...
                : culturalFoodContext;
            updateDraft({ dietaryPreferences, culturalFoodContext: resolvedCultural });
        }, 300);
        return () => clearTimeout(timer);
    }, [dietaryPreferences, culturalFoodContext, otherCulturalInput, updateDraft]);
    ...
    return (
        ...
        >
            ...
            <View style={styles.section}>
                <Text style={styles.sectionLabel}>CULTURAL FOOD TRADITIONS</Text>
                <View style={styles.chipsContainer}>
